...
export const ROUTES: RouteInfo[] = [
    ...
    {
        path: '/agenda', title: 'Agenda', icon: 'icon-calendar', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    {
        path: '/tareas', title: 'Tareas', icon: 'icon-layers', class: '', badge: '', badgeClass: '', isExternalLink: false, submenu: []
    },
    {
        path: '', title: 'Clientes', icon: 'icon-users', class: 'has-sub', badge: '', badgeClass: '', isExternalLink: false, submenu: [
            {
